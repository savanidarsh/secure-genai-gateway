...
resource "aws_s3_bucket" "logs" {
  ...
  #checkov:skip=CKV2_AWS_61:Lifecycle expiration is cost-hygiene, not a security control; intentionally out of scope here
  #checkov:skip=CKV2_AWS_62:No consumer needs S3 event notifications for this bucket
  #checkov:skip=CKV_AWS_144:Cross-region replication is a disaster-recovery concern, out of scope here
