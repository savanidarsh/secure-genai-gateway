...
resource "aws_cloudwatch_log_group" "lambda" {
  ...
  retention_in_days = 365 # CKV_AWS_338 wants >= 1 yr for forensic/audit history
...
resource "aws_lambda_function" "gateway" {
  ...
  #checkov:skip=CKV_AWS_272:Code-signing is an enterprise supply-chain control, out of scope for this project
